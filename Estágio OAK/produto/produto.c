...
int cadastro(Produto listaProduto[], int *totalProduto){
    ...
    float valor_c;
    char status_c[4];
    size_t tamanhoString; /* obs.: usado para auxiliar o cÃ¡lculo do tamanho da string */
    ...
    /* O if acima garante que o nome inserido tenha o terminador padrÃ£o de string em C */
